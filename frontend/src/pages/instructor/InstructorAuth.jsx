...
function InstructorAuth() {
    ...
    return (
        <Container>
            {/* <div className='w-full flex justify-center font-[poppins] mb-2'>Instructor</div> */}
            <h1 className='text-center font-[poppins] mb-2 font-medium text-2xl'>Instructor</h1>
